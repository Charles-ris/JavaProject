...
public class RattrapageImport {
    ...
    //constructeurs
    public RattrapageImport(String filename) {
        super();
    ...
    private boolean add(String g1, String g2) {
        ...
        sql = "INSERT into Rattrapage(idgrp1,idgrp2)"
                +" VALUES(?,?)";
        try {
    ...
    public static void main(String[] args) {
        ...
        //traitement
        RattrapageImport el = new RattrapageImport("assoc-remplacer-Tableau 1.csv");
